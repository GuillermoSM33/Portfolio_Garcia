    ...
    return (
        <>
            ...
            <article className="relative bg-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center md:gap-4 gap-8 overflow-hidden shadow-xl">
                {/* Triangle */}
                <div className="hola absolute top-0 left-0 w-0 h-0 border-r-[150px] md:border-r-[200px] border-r-transparent border-t-[150px] md:border-t-[200px] border-t-transparent border-l-[150px] md:border-l-[200px] border-l-[#91b7fe] border-b-[150px] md:border-b-[200px] border-b-[#f7a82f]" />
                {/* Image */}
                <section className="col-span-1 flex items-center justify-center p-8 z-20">
                    <img
                        src={Image}
                        className="mt-8 md:mt-0 w-40 h-40 object-cover rounded-full p-1 bg-[#a4f7e6] ring-8 ring-white"
                    />
                </section>
                    ...
                    <ul className="ml-2 mt-10 text-gray-500 border-l-2 border-[#f5a72d]">
                        <li className="flex items-center gap-2 text-xs mb-2">
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                className="w-5 h-5 p-1 bg-[#f5a72d] text-white rounded-full -ml-[11px]"
                            >
                                <path
                                    fillRule="evenodd"
                        ...
                        <li className="flex items-center gap-2 text-xs mb-2">
                            ...
                            <span>guillermo.jesus.garcia.canul@gmail.com</span>
                        </li>
                        <li className="flex items-center gap-2 text-xs mb-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span>https://github.com/GuillermoSM33</span>
                        </li>
                    </ul>
                    {/* Social media */}
                    <ul className="mt-4 flex items-center justify-end gap-2">
                        <li>
                            <a href="tel: 9983187269" className="text-white">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                        ...
                        <li>
                            <a href="mailto:guillermo.jesus.garcia.canul@gmail.com" className="text-white">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                        ...
                        <li>
                            <a href="https://github.com/GuillermoSM33" className="text-white">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
